...
const About = () => {
  return (
    <section className='flex w-[82.93%] flex-col'>
        ...
        >
          ...
          <div className='flex flex-col gap-4'>
            <p className='font-body-1 text-light-slate'>
              ...
              in 2020 when I decided to try learning how to code during the
              corona virus lock down out of boredom — turns out taking Jennifer
              Niederst Robbins&apos;s Learning Web Design book made me fell in
              love with the craft!
            </p>
            <p className='font-body-1 text-light-slate'>
